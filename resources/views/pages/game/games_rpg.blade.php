...
body{
   ...
   <h2 class="ui center aligned header" style="color:white;font-size: 3.5ch;">Game nhập vai Role-Playing Game (RPG)</h2>      
...
<div style="height:200px"></div>
 ...
 <script>
      document.getElementById('3').className='active item';

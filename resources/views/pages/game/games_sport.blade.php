...
body{
   ...
   <h2 class="ui center aligned header" style="color:white;font-size: 3.5ch;">Game thể thao</h2>      
   @if(count($games)==0)
   <h1 class='ui center aligned header' style='color:white;text-align: center;'  id='no'>Không có kết quả !</h1>
...
<div style="height:200px"></div>
 ...
 <script>
      document.getElementById('5').className='active item';

...
body{
   ...
   <h2 class="ui center aligned header" style="color:white;font-size: 3.5ch;">Real-Time Stratery Game chiến thực thời gian thực (RTS)</h2>      
...
<div style="height:200px"></div>
 ...
 <script>
      document.getElementById('4').className='active item';
